...
- **board-of-advisors** — Say "build my board" and seat five advisors of your choosing (investors, authors, mentors, even fictional detectives). Then bring any decision: "run this by the board." Each advisor weighs in through their own lens, and the skill shows you where they disagree — because the disagreement is the point.
- **research-brief** — Say "get me smart on" any topic, company, or decision. Three-pass research, graded sources, bottom line first.
- **roast** — Puts your idea in front of a five-persona panel and returns a verdict: go, reshape, or kill, plus the cheapest 48-hour test.
- **meetings** — Prices a proposed meeting in real dollars before you book it, then builds agendas that refuse topics without a desired outcome.
- **weekly-review** — A proper GTD weekly review that won't let you skip steps.

## The classics: 28 bestselling business books as working frameworks

Negotiation and influence: **negotiation** (Voss, Never Split the Difference), **influence-psychology** (Cialdini).

Offers, positioning and messaging: **hundred-million-offers** (Hormozi), **obviously-awesome** (Dunford), **storybrand-messaging** (Miller), **made-to-stick** (Heath brothers), **contagious** (Berger), **one-page-marketing** (Dib), **scorecard-marketing**, **cro-methodology**.

Strategy: **good-strategy-bad-strategy** (Rumelt), **blue-ocean-strategy**, **crossing-the-chasm** (Moore), **cold-start-problem** (Chen), **traction-eos** (Wickman), **37signals-way**.

Customers and product: **mom-test** (Fitzpatrick), **jobs-to-be-done** (Christensen), **continuous-discovery** (Torres), **inspired-product** (Cagan), **hooked-ux** (Eyal), **design-sprint** (Knapp), **monetizing-innovation**.

Growth and metrics: **lean-startup** (Ries), **lean-analytics**, **predictable-revenue** (Ross).

Leading people: **high-output-management** (Grove), **drive-motivation** (Pink).

## Try it

"Set up my morning brief for weekdays at 7." "Prep me for tomorrow's 10am." "Build my board of advisors." "Run my offer through the $100M Offers diagnostic." "Roast this idea." "Reply to this email." "Make this sound less AI."
